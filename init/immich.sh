...
for attempt in 1 2 3; do
    wget -q -O /root/immich-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/immich.sh && [ -s /root/immich-install.sh ] && break
    sleep 5
done
...
[ -s /root/immich-install.sh ] && bash /root/immich-install.sh
STUB
...
echo "[$(date)] Immich Installation Started"
