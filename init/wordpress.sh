...
for attempt in 1 2 3; do
    wget -q -O /root/wordpress-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/wordpress.sh && [ -s /root/wordpress-install.sh ] && break
    sleep 5
done
...
[ -s /root/wordpress-install.sh ] && bash /root/wordpress-install.sh
STUB
...
echo "[$(date)] WordPress Installation Started"
