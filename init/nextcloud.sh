...
for attempt in 1 2 3; do
    wget -q -O /root/nextcloud-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/nextcloud.sh && [ -s /root/nextcloud-install.sh ] && break
    sleep 5
done
...
[ -s /root/nextcloud-install.sh ] && bash /root/nextcloud-install.sh
STUB
