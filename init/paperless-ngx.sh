...
for attempt in 1 2 3; do
    wget -q -O /root/paperless-ngx-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/paperless-ngx.sh && [ -s /root/paperless-ngx-install.sh ] && break
    sleep 5
done
...
[ -s /root/paperless-ngx-install.sh ] && bash /root/paperless-ngx-install.sh
STUB
...
echo "[$(date)] Paperless-ngx Installation Started"
