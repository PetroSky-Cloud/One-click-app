...
for attempt in 1 2 3; do
    wget -q -O /root/plausible-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/plausible.sh && [ -s /root/plausible-install.sh ] && break
    sleep 5
done
...
[ -s /root/plausible-install.sh ] && bash /root/plausible-install.sh
STUB
...
echo "[$(date)] Plausible Installation Started"
