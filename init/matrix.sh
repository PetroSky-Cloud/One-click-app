...
for attempt in 1 2 3; do
    wget -q -O /root/matrix-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/matrix.sh && [ -s /root/matrix-install.sh ] && break
    sleep 5
done
...
[ -s /root/matrix-install.sh ] && bash /root/matrix-install.sh
STUB
...
echo "[$(date)] Matrix/Element Installation Started"
