...
for attempt in 1 2 3; do
    wget -q -O /root/photoprism-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/photoprism.sh && [ -s /root/photoprism-install.sh ] && break
    sleep 5
done
...
[ -s /root/photoprism-install.sh ] && bash /root/photoprism-install.sh
STUB
...
echo "[$(date)] PhotoPrism Installation Started"
