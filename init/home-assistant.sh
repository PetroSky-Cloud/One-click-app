...
for attempt in 1 2 3; do
    wget -q -O /root/home-assistant-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/home-assistant.sh && [ -s /root/home-assistant-install.sh ] && break
    sleep 5
done
...
[ -s /root/home-assistant-install.sh ] && bash /root/home-assistant-install.sh
STUB
...
echo "[$(date)] Home Assistant Installation Started"
