...
for attempt in 1 2 3; do
    wget -q -O /root/rocketchat-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/rocketchat.sh && [ -s /root/rocketchat-install.sh ] && break
    sleep 5
done
...
[ -s /root/rocketchat-install.sh ] && bash /root/rocketchat-install.sh
STUB
...
echo "[$(date)] Rocket.Chat Installation Started"
