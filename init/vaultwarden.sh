...
for attempt in 1 2 3; do
    wget -q -O /root/vaultwarden-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/vaultwarden.sh && [ -s /root/vaultwarden-install.sh ] && break
    sleep 5
done
...
[ -s /root/vaultwarden-install.sh ] && bash /root/vaultwarden-install.sh
STUB
