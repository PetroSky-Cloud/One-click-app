...
for attempt in 1 2 3; do
    wget -q -O /root/appwrite-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/appwrite.sh && [ -s /root/appwrite-install.sh ] && break
    sleep 5
done
...
[ -s /root/appwrite-install.sh ] && bash /root/appwrite-install.sh
STUB
...
echo "[$(date)] Appwrite Installation Started"
