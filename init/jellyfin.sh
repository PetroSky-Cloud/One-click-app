...
for attempt in 1 2 3; do
    wget -q -O /root/jellyfin-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/jellyfin.sh && [ -s /root/jellyfin-install.sh ] && break
    sleep 5
done
...
[ -s /root/jellyfin-install.sh ] && bash /root/jellyfin-install.sh
STUB
...
echo "[$(date)] Jellyfin Installation Started"
