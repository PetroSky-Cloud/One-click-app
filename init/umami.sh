...
for attempt in 1 2 3; do
    wget -q -O /root/umami-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/umami.sh && [ -s /root/umami-install.sh ] && break
    sleep 5
done
...
[ -s /root/umami-install.sh ] && bash /root/umami-install.sh
STUB
...
echo "[$(date)] Umami Installation Started"
