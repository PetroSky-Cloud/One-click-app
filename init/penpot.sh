...
for attempt in 1 2 3; do
    wget -q -O /root/penpot-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/penpot.sh && [ -s /root/penpot-install.sh ] && break
    sleep 5
done
...
[ -s /root/penpot-install.sh ] && bash /root/penpot-install.sh
STUB
...
echo "[$(date)] Penpot Installation Started"
