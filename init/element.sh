...
for attempt in 1 2 3; do
    wget -q -O /root/element-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/element.sh && [ -s /root/element-install.sh ] && break
    sleep 5
done
...
[ -s /root/element-install.sh ] && bash /root/element-install.sh
STUB
...
echo "[$(date)] Element Web Installation Started"
