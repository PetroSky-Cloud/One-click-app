...
for attempt in 1 2 3; do
    wget -q -O /root/outline-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/outline.sh && [ -s /root/outline-install.sh ] && break
    sleep 5
done
...
[ -s /root/outline-install.sh ] && bash /root/outline-install.sh
STUB
...
echo "[$(date)] Outline Installation Started"
