...
for attempt in 1 2 3; do
    wget -q -O /root/rustdesk-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/rustdesk.sh && [ -s /root/rustdesk-install.sh ] && break
    sleep 5
done
...
[ -s /root/rustdesk-install.sh ] && bash /root/rustdesk-install.sh
STUB
...
echo "[$(date)] RustDesk Server Installation Started"
