...
for attempt in 1 2 3; do
    wget -q -O /root/docmost-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/docmost.sh && [ -s /root/docmost-install.sh ] && break
    sleep 5
done
...
[ -s /root/docmost-install.sh ] && bash /root/docmost-install.sh
STUB
...
echo "[$(date)] Docmost Installation Started"
