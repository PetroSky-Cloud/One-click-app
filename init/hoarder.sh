...
for attempt in 1 2 3; do
    wget -q -O /root/hoarder-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/hoarder.sh && [ -s /root/hoarder-install.sh ] && break
    sleep 5
done
...
[ -s /root/hoarder-install.sh ] && bash /root/hoarder-install.sh
STUB
...
echo "[$(date)] Hoarder Installation Started"
