...
for attempt in 1 2 3; do
    wget -q -O /root/uptime-kuma-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/uptime-kuma.sh && [ -s /root/uptime-kuma-install.sh ] && break
    sleep 5
done
...
[ -s /root/uptime-kuma-install.sh ] && bash /root/uptime-kuma-install.sh
STUB
...
echo "[$(date)] Uptime Kuma Installation Started"
