...
for attempt in 1 2 3; do
    wget -q -O /root/listmonk-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/listmonk.sh && [ -s /root/listmonk-install.sh ] && break
    sleep 5
done
...
[ -s /root/listmonk-install.sh ] && bash /root/listmonk-install.sh
STUB
...
echo "[$(date)] Listmonk Installation Started"
