...
for attempt in 1 2 3; do
    wget -q -O /root/gitea-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/gitea.sh && [ -s /root/gitea-install.sh ] && break
    sleep 5
done
...
[ -s /root/gitea-install.sh ] && bash /root/gitea-install.sh
STUB
...
echo "[$(date)] Gitea Installation Started"
