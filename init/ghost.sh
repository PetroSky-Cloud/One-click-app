...
for attempt in 1 2 3; do
    wget -q -O /root/ghost-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/ghost.sh && [ -s /root/ghost-install.sh ] && break
    sleep 5
done
...
[ -s /root/ghost-install.sh ] && bash /root/ghost-install.sh
STUB
...
echo "[$(date)] Ghost Installation Started"
