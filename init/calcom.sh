...
for attempt in 1 2 3; do
    wget -q -O /root/calcom-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/calcom.sh && [ -s /root/calcom-install.sh ] && break
    sleep 5
done
...
[ -s /root/calcom-install.sh ] && bash /root/calcom-install.sh
STUB
...
echo "[$(date)] Cal.com Installation Started"
