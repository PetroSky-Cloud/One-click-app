...
for attempt in 1 2 3; do
    wget -q -O /root/coolify-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/coolify.sh && [ -s /root/coolify-install.sh ] && break
    sleep 5
done
...
[ -s /root/coolify-install.sh ] && bash /root/coolify-install.sh
STUB
...
echo "[$(date)] Coolify Installation Started"
