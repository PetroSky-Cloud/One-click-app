...
for attempt in 1 2 3; do
    wget -q -O /root/typebot-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/typebot.sh && [ -s /root/typebot-install.sh ] && break
    sleep 5
done
...
[ -s /root/typebot-install.sh ] && bash /root/typebot-install.sh
STUB
...
echo "[$(date)] Typebot Installation Started"
