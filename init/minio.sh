...
for attempt in 1 2 3; do
    wget -q -O /root/minio-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/minio.sh && [ -s /root/minio-install.sh ] && break
    sleep 5
done
...
[ -s /root/minio-install.sh ] && bash /root/minio-install.sh
STUB
...
echo "[$(date)] MinIO Installation Started"
