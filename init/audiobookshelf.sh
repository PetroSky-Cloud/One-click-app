...
for attempt in 1 2 3; do
    wget -q -O /root/audiobookshelf-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/audiobookshelf.sh && [ -s /root/audiobookshelf-install.sh ] && break
    sleep 5
done
...
[ -s /root/audiobookshelf-install.sh ] && bash /root/audiobookshelf-install.sh
STUB
...
echo "[$(date)] Audiobookshelf Installation Started"
