...
for attempt in 1 2 3; do
    wget -q -O /root/pihole-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/pihole.sh && [ -s /root/pihole-install.sh ] && break
    sleep 5
done
...
[ -s /root/pihole-install.sh ] && bash /root/pihole-install.sh
STUB
...
echo "[$(date)] Pi-hole Installation Started"
