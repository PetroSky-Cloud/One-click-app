...
for attempt in 1 2 3; do
    wget -q -O /root/flowise-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/flowise.sh && [ -s /root/flowise-install.sh ] && break
    sleep 5
done
...
[ -s /root/flowise-install.sh ] && bash /root/flowise-install.sh
STUB
...
echo "[$(date)] Flowise Installation Started"
