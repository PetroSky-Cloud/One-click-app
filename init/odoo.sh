...
for attempt in 1 2 3; do
    wget -q -O /root/odoo-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/odoo.sh && [ -s /root/odoo-install.sh ] && break
    sleep 5
done
...
[ -s /root/odoo-install.sh ] && bash /root/odoo-install.sh
STUB
...
echo "[$(date)] Odoo Installation Started"
