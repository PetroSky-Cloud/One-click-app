...
for attempt in 1 2 3; do
    wget -q -O /root/mattermost-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/mattermost.sh && [ -s /root/mattermost-install.sh ] && break
    sleep 5
done
...
[ -s /root/mattermost-install.sh ] && bash /root/mattermost-install.sh
STUB
...
echo "[$(date)] Mattermost Installation Started"
