...
for attempt in 1 2 3; do
    wget -q -O /root/jitsi-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/jitsi.sh && [ -s /root/jitsi-install.sh ] && break
    sleep 5
done
...
[ -s /root/jitsi-install.sh ] && bash /root/jitsi-install.sh
STUB
...
echo "[$(date)] Jitsi Installation Started"
