...
for attempt in 1 2 3; do
    wget -q -O /root/n8n-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/n8n.sh && [ -s /root/n8n-install.sh ] && break
    sleep 5
done
...
[ -s /root/n8n-install.sh ] && bash /root/n8n-install.sh
STUB
