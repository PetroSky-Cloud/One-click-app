...
for attempt in 1 2 3; do
    wget -q -O /root/pocketbase-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/pocketbase.sh && [ -s /root/pocketbase-install.sh ] && break
    sleep 5
done
...
[ -s /root/pocketbase-install.sh ] && bash /root/pocketbase-install.sh
STUB
...
echo "[$(date)] PocketBase Installation Started"
