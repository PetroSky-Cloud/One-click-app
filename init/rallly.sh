...
for attempt in 1 2 3; do
    wget -q -O /root/rallly-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/rallly.sh && [ -s /root/rallly-install.sh ] && break
    sleep 5
done
...
[ -s /root/rallly-install.sh ] && bash /root/rallly-install.sh
STUB
...
echo "[$(date)] Rallly Installation Started"
