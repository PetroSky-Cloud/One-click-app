...
for attempt in 1 2 3; do
    wget -q -O /root/linkwarden-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/linkwarden.sh && [ -s /root/linkwarden-install.sh ] && break
    sleep 5
done
...
[ -s /root/linkwarden-install.sh ] && bash /root/linkwarden-install.sh
STUB
...
echo "[$(date)] Linkwarden Installation Started"
