...
for attempt in 1 2 3; do
    wget -q -O /root/meilisearch-install.sh https://raw.githubusercontent.com/PetroSky-Cloud/One-click-app/main/meilisearch.sh && [ -s /root/meilisearch-install.sh ] && break
    sleep 5
done
...
[ -s /root/meilisearch-install.sh ] && bash /root/meilisearch-install.sh
STUB
...
echo "[$(date)] Meilisearch Installation Started"
